...
import com.laconic.hyperxengine.util.RecyclerAdapter
...
class GamepadOverlay(private val ctx: Context, attrs: AttributeSet?) : LinearLayout(ctx,attrs) {
    ...
    lateinit var activity: EmulatorActivity
    ...
    init{
        val styledAttr = context.theme.obtainStyledAttributes(
            attrs,
    ...
    fun attachActivity(actv: EmulatorActivity){
        activity = actv
    }
