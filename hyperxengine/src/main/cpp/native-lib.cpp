...
Java_com_laconic_hyperxengine_GLSprite_getVideoBuffer(
        JNIEnv *env,
    ...
    jclass clazz = env->FindClass("com/laconic/hyperxengine/GLSprite");
...
extern "C"
JNIEXPORT void JNICALL
Java_com_laconic_hyperxengine_JniKt_startAudioEngine(
    JNIEnv *env,
    jobject instance,
    jintArray jCpuIds
) {
  std::vector<int> cpuIds = javaArrayToStdVector(env, jCpuIds);
  engine.start(cpuIds, gJvm, &soundManager);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_laconic_hyperxengine_JniKt_stopAudioEngine(JNIEnv *env, jobject instance) {
  engine.stop();
}

extern "C"
JNIEXPORT void JNICALL
Java_com_laconic_hyperxengine_JniKt_pauseAudioEngine(JNIEnv *env, jobject instance) {
  engine.pause();
}

extern "C"
JNIEXPORT void JNICALL
Java_com_laconic_hyperxengine_JniKt_resumeAudioEngine(JNIEnv *env, jobject instance) {
  engine.resume();
}

extern "C"
JNIEXPORT jintArray JNICALL
Java_com_laconic_hyperxengine_app_MainActivity_00024Companion_getAudioBuffer(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_laconic_hyperxengine_GamepadOverlay_pressButton(JNIEnv *env, jobject thiz, jint button) {
    if(pceConsole != nullptr){
        pceConsole->SetControllerInput(button);
    }
}
extern "C"
JNIEXPORT void JNICALL
Java_com_laconic_hyperxengine_GamepadOverlay_releaseButton(JNIEnv *env, jobject thiz, jint button) {
    if(pceConsole != nullptr){
...
extern "C"
JNIEXPORT void JNICALL
Java_com_laconic_hyperxengine_Emulator_loadROM(JNIEnv *env, jobject thiz, jbyteArray rom_data) {
    if(pceConsole == nullptr){
        soundManager = SoundManager();
...
extern "C"
JNIEXPORT void JNICALL
Java_com_laconic_hyperxengine_Emulator_runFrame(JNIEnv *env, jobject thiz) {
    pceConsole->RunFrame();
}
extern "C"
JNIEXPORT void JNICALL
Java_com_laconic_hyperxengine_Emulator_saveState(JNIEnv *env, jobject thiz, jstring file) {
    jboolean isCopy;
...
extern "C"
JNIEXPORT void JNICALL
Java_com_laconic_hyperxengine_Emulator_loadState(JNIEnv *env, jobject thiz, jstring file) {
    jboolean isCopy;
    const char *convertedValue = env->GetStringUTFChars(file,&isCopy);
