...
#ifndef KTNES_BASECONTROLDEVICE_H
#define KTNES_BASECONTROLDEVICE_H
...
public:
    ...
    BaseControlDevice(ControllerType type, uint8_t port, KeyMappingSet keyMappingSet = KeyMappingSet());
...
#endif //KTNES_BASECONTROLDEVICE_H
